...
//import logo from '../assets/img/space_x_logo_bw_centered.svg';
  ...
  render() {
    ...
    return (
      <header className='header'>
        <a href="https://nuclearsecrecy.com/nukemap/"><btn className="header__btn">
        <img className='header__arrow' src={arrow} />
        <div className="header__line"></div> 
          {textBtn}
        </btn></a>
    <svg className='header__logo' xmlns="http://www.w3.org/2000/svg" width="50" height="10" viewBox="0 0 590 73">
